...
export default function OthelloGame({ scenario }: { scenario: AbstractStrategyScenario }) {
  void scenario; // scenario is currently ignored — Othello is always the same ruleset
